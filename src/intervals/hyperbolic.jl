...
function sinh{T}(a::Interval{T})
    ...
    return Interval(@round(sinh(a.lo), sinh(a.hi)))
end

function cosh{T}(a::Interval{T})
    isempty(a) && return a

    return Interval(@round(cosh(mig(a)), cosh(mag(a))))
end
...
function tanh(a::Interval{BigFloat})
    ...
    return Interval(@round(tanh(a.lo), tanh(a.hi)))
end
...
function asinh(a::Interval{BigFloat})
    ...
    return Interval(@round(asinh(a.lo), asinh(a.hi)))
end
...
function acosh(a::Interval{BigFloat})
    ...
    return Interval(@round(acosh(a.lo), acosh(a.hi)))
end
...
function atanh(a::Interval{BigFloat})
    ...
    result = Interval(@round(atanh(a.lo), atanh(a.hi)))
