...
"""
@inline function bisect(X::Interval, α=where_bisect)
    @assert 0 ≤ α ≤ 1
...
"""
@inline function bisect(X::IntervalBox, α=where_bisect)
...
"""
@inline function bisect(X::IntervalBox, i::Integer, α=where_bisect)
